...
This workspace was generated by \`site-proofread prepare-review\`.

Review mode: ${renderModeLabel(mode)}

## Workflow

1. Run \`site-proofread extract\`.
2. Run \`site-proofread prepare-review <client-name>\`.
3. Open the \`site-proofread\` project root as the Codex workspace.
