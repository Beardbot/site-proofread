...
This workspace was generated by \`proofread-agent prepare\`.

Review mode: ${renderModeLabel(mode)}

## Workflow

1. Run \`site-copy-audit\`.
2. Run \`proofread-agent prepare <client-name>\`.
3. Open the \`proofread-agent\` project root as the Codex workspace.
